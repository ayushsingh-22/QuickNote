package com.amvarpvtltd.selfnote.permissions
...
class PermissionManager(
    ...
    data class PermissionConfig(
        val rationaleMessage: String = "📱 QuickNote needs notification permission to send you smart reminders for your notes.",
