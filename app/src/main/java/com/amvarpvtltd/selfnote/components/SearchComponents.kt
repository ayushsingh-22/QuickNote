...
import com.amvarpvtltd.selfnote.search.SearchAndSortManager
import com.amvarpvtltd.selfnote.search.SortOption
...
fun ThemeToggleButton(
    currentTheme: com.amvarpvtltd.selfnote.theme.ThemeMode,
    onThemeChange: (com.amvarpvtltd.selfnote.theme.ThemeMode) -> Unit,
    modifier: Modifier = Modifier
) {
    val hapticFeedback = LocalHapticFeedback.current
    ...
    Card(
        modifier = modifier
            .clickable {
                ...
                val nextTheme = when (currentTheme) {
                    com.amvarpvtltd.selfnote.theme.ThemeMode.LIGHT -> com.amvarpvtltd.selfnote.theme.ThemeMode.DARK
                    com.amvarpvtltd.selfnote.theme.ThemeMode.DARK -> com.amvarpvtltd.selfnote.theme.ThemeMode.SYSTEM
                    com.amvarpvtltd.selfnote.theme.ThemeMode.SYSTEM -> com.amvarpvtltd.selfnote.theme.ThemeMode.LIGHT
                }

                // Show toast notification based on the theme being changed to
                val toastMessage = when (nextTheme) {
                    com.amvarpvtltd.selfnote.theme.ThemeMode.LIGHT -> "🌞 Light mode activated"
                    com.amvarpvtltd.selfnote.theme.ThemeMode.DARK -> "🌙 Dark mode activated"
                    com.amvarpvtltd.selfnote.theme.ThemeMode.SYSTEM -> "🔄 System theme activated"
                }
        ...
        Box(
            ...
            val (icon, contentDescription) = when (currentTheme) {
                com.amvarpvtltd.selfnote.theme.ThemeMode.LIGHT -> Icons.Outlined.LightMode to "Light mode"
                com.amvarpvtltd.selfnote.theme.ThemeMode.DARK -> Icons.Outlined.DarkMode to "Dark mode"
                com.amvarpvtltd.selfnote.theme.ThemeMode.SYSTEM -> Icons.Outlined.SettingsBrightness to "System theme"
            }
