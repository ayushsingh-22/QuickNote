package com.amvarpvtltd.selfnote.theme
...
fun ProvideNoteTheme(
    ...
    LaunchedEffect(colors) {
        with(colors) {
            com.amvarpvtltd.selfnote.design.NoteTheme.Primary = primary
            com.amvarpvtltd.selfnote.design.NoteTheme.PrimaryVariant = primaryVariant
            com.amvarpvtltd.selfnote.design.NoteTheme.Secondary = secondary
            com.amvarpvtltd.selfnote.design.NoteTheme.SecondaryVariant = secondaryVariant
            com.amvarpvtltd.selfnote.design.NoteTheme.Background = background
            com.amvarpvtltd.selfnote.design.NoteTheme.Surface = surface
            com.amvarpvtltd.selfnote.design.NoteTheme.SurfaceVariant = surfaceVariant
            com.amvarpvtltd.selfnote.design.NoteTheme.OnPrimary = onPrimary
            com.amvarpvtltd.selfnote.design.NoteTheme.OnBackground = onBackground
            com.amvarpvtltd.selfnote.design.NoteTheme.OnSurface = onSurface
            com.amvarpvtltd.selfnote.design.NoteTheme.OnSurfaceVariant = onSurfaceVariant
            com.amvarpvtltd.selfnote.design.NoteTheme.Success = success
            com.amvarpvtltd.selfnote.design.NoteTheme.Warning = warning
            com.amvarpvtltd.selfnote.design.NoteTheme.Error = error
            com.amvarpvtltd.selfnote.design.NoteTheme.ErrorContainer = errorContainer
        }
    }
